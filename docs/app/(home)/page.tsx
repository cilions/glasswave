      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        <div className="max-w-2xl w-full text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-4">
            Create stunning UIs
            <br />
            <span className="font-normal opacity-80">with glassmorphism effects</span>
          </h1>
          <p className="opacity-70 text-lg mb-8">
            A modern CSS components library for building beautiful, adaptive interfaces with smooth
            glass-like visuals and effortless theming.
          </p>
